...
class OrderField(models.PositiveIntegerField):
    ...
    def pre_save(self, model_instance, add):
        ...
        #self.model.objects.all() gets all objects in the model specifiedwhich isFlowTask
        ...
        if getattr(model_instance, self.attname) is None:
            try:
                if self.for_field:
                    ...
                    #filter the model objects to only return objects with thee field specified in the for_field
